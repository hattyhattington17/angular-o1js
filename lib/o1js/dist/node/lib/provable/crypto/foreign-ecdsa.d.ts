...
import { FlexiblePoint, ForeignCurve, ForeignCurveV2 } from './foreign-curve.js';
...
declare class EcdsaSignature {
     ...
     */
    verifySignedHashV2(msgHash: AlmostForeignField | bigint, publicKey: FlexiblePoint): Bool;
    /**
...
declare class EcdsaSignatureV2 extends EcdsaSignature {
    constructor(signature: {
        r: AlmostForeignField | Field3 | bigint | number;
        s: AlmostForeignField | Field3 | bigint | number;
    });
 ...
 */
declare function createEcdsaV2(curve: CurveParams | typeof ForeignCurveV2): typeof EcdsaSignatureV2;
