...
export { createForeignCurve, createForeignCurveV2, ForeignCurve, ForeignCurveV2, };
...
declare class ForeignCurveV2 extends ForeignCurve {
    constructor(g: {
        x: AlmostForeignField | Field3 | bigint | number;
        y: AlmostForeignField | Field3 | bigint | number;
    });
 ...
 */
declare function createForeignCurveV2(params: CurveParams): typeof ForeignCurveV2;
