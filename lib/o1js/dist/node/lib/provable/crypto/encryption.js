...
export { encrypt, decrypt, encryptV2, decryptV2, encryptBytes, decryptBytes, };
/**
 ...
 * Decrypts a {@link CipherText} using a {@link PrivateKey}.
 */
function decryptV2({ publicKey, cipherText }, privateKey) {
    // key exchange
 ...
 */
function encryptV2(message, otherPublicKey) {
    // key exchange
...
function encryptBytes(message, otherPublicKey) {
    ...
    return {
        ...encryptV2(chunks.map((chunk) => bytesToWord(chunk)), otherPublicKey),
        messageLength,
    };
}
/**
